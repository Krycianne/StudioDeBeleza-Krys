...
import { IUnha } from '../unha';
import { UnhaService } from '../unha.service';
import { ActivatedRoute } from '@angular/router';
@Component({
  selector: 'app-unha-em-gel',
  templateUrl: './unha-em-gel.component.html',
  styleUrls: ['./unha-em-gel.component.css']
})
export class UnhaEmGelComponent implements OnInit {
  //= produtos;   substitui por undefined//
unha : IUnha[] | undefined;     // tem que importar o IPproduto, é a interface criada em produtos.ts


constructor(
private unhaService: UnhaService,  // injetei
...
const unha = this.unhaService.getAll();    ///vai receber todos os produtos
...
this.unha = unha.filter(unha => unha.descricao.toLowerCase().includes(descricao));
